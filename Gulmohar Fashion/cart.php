      ...
      <table class="table table-bordered table-condensed table-striped">
        ...
        <tbody>
          ...
          foreach ($items as $item) {
            $product_id = $item['id'];
            $productQ = $db->query("SELECT * FROM products WHERE products_id = '{$product_id}'");
            ...
            <tr>
              ...
              <td>
                <button class="btn btn-xs btn-default" onclick="update_cart('removeone','<?=$product['products_id'];?>','<?=$item['size'];?>');">-</button>
                <?=$item['quantity'];?>
                <?php if($item['quantity'] < $available) : ?>
                  <button class="btn btn-xs btn-default" onclick="update_cart('addone','<?=$product['products_id'];?>','<?=$item['size'];?>');">+</button>
                <?php else: ?>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h1 class="modal-title" id="checkoutModalLabel">Shipping Address</h1>
            </div>
            <div class="modal-body">
              <div class="row">
                <form id ="payment-form" action="thankYou.php" method="post">
                  ...
                  <input type="hidden" name="description" value="<?=$item_count.' item'.(($item_count>1)?'s':'').' from Beauty Glamour';?>">
...
function check_address(){
  ...
  jQuery.ajax({
    url : '/shoptime/admin/parsers/check_address.php',
    method : 'POST',
    data : data,
