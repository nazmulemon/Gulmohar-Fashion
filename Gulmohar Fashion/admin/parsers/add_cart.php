...
$query = $db->query("SELECT * FROM products WHERE products_id = '{$product_id}'");
...
if($cart_id != ''){
  ...
  $db->query("UPDATE cart SET items = '{$items_json}',expire_date = '{$cart_expire}' WHERE cart_id = '{$cart_id}'");
