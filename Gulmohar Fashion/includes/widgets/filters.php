...
<form action="search.php" method="post">
  ...
  <?php while($brand = mysqli_fetch_assoc($brandQ)):?>
    <input type="radio" name="brand" value="<?=$brand['brand_id'];?>"<?=(($b == $brand['brand_id'])?' checked':'');?>><?=$brand['brand'];?><br>
  <?php endwhile;?>
  <input type="submit" name="" class="btn btn-xs btn-primary" value="Search">
</form>
